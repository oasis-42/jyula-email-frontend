...
function ToolBarLayout() {
  ...
  const buttonsDataSecond = [
    ...
    { label: "Audiência", icon: <SwitchAccountIcon />, to: "/app/audiencia" },
    { label: "Enviados", icon: <OutboxIcon />, to: "/app/enviados" },
    { label: "Favoritos", icon: <GradeIcon />, to: "/app/favoritos" },
    { label: "Relatórios", icon: <AssessmentIcon />, to: "/app/relatorios" },
  ];
  return (
